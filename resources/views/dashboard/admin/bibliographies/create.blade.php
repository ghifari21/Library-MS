...
<h2 class="text-center mb-3">Add Bibliography Form</h2>
<div class="row justify-content-center">
    <div class="col-lg-8">
        <main class="form-registration w-100 mt-3 mb-5">
            <form action="/dashboard/bibliographies" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-floating mb-3">
                    <input type="text" name="title" class="form-control rounded-top @error('title') is-invalid @enderror" id="title" placeholder="title" required value="{{ old('title') }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <div class="form-floating">
                            <input type="text" class="form-control @error('isbn') is-invalid @enderror" id="isbn" name="isbn" placeholder="ISBN" value="{{ old('isbn') }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-floating">
                            <input type="text" class="form-control @error('published_year') is-invalid @enderror" id="year" name="published_year" placeholder="Published Year" value="{{ old('published_year') }}" required>
