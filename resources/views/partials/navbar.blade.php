<nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
    <div class="container">
        <a class="navbar-brand" href="/home">Library MS</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('bibliographies*') ? 'active' : '' }}" href="/bibliographies">Bibliographies</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('publishers*') ? 'active' : '' }}" href="/publishers">Publishers</a>
                </li>
            </ul>
